 ...
 * @author Tonic Artos
 */
public class StickyGridHeadersHoloAdapterWrapper extends BaseAdapter {
    ...
    private StickyGridHeadersHoloGridView mDridView;

    private final List<View> mHeaderCache = new ArrayList<View>();
    private int mNumColumns = 1;
    private View[] mRowSiblings;

    public StickyGridHeadersHoloAdapterWrapper(Context context, StickyGridHeadersHoloGridView gridView,
    ...
    protected class ReferenceView extends FrameLayout {
        ...
        protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
            ...
            if (mNumColumns == 1 || StickyGridHeadersHoloAdapterWrapper.this.mRowSiblings == null) {
                return;
            }
